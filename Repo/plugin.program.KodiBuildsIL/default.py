...
ADDON=xbmcaddon.Addon(id='plugin.program.KodiBuildsIL')
    
    
VERSION = "1.0.0"
PATH = "Kodi Builds IL Wizard"            

    
def CATEGORIES():
    link = OPEN_URL('https://copy.com/AD4Xd9Rd12H6VTJQ/Kodi%20Builds%20IL.txt?download=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("senyor Wizard","Downloading ",'', 'Please Wait')
